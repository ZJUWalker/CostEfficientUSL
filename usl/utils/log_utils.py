...
def timeit(info: str = None):
    ...
    Args:
        logger: 可选的 logging.Logger，如果提供则用 logger.info 打印时间。
        name:   自定义名字，如果不提供则使用函数名。
    """
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            try:
                ...
                elapsed = (time.time() - start) * 1000.0  # 毫秒
                func_name = func.__name__
                msg = f"[TimeIt {info}] {func_name} took {elapsed:.6f} ms"
                print(f'{msg}')
